...
(5, 'web_site_description', 'SEO描述', 'SEO描述', '', '', 6, 1, 'textarea', '网站搜索引擎描述', 1378898976,  6, 1),
(6, 'web_site_keyword', 'SEO关键字', 'SEO关键字', '', '', 6, 1, 'textarea', '网站搜索引擎关键字', 1378898976,  4, 1),
(7, 'web_site_copyright', '版权信息', '版权信息', '', '', 1, 0, 'text', '设置在网站底部显示的版权信息', 1406991855,  7, 1),
(8, 'web_site_icp', '网站备案号', '网站备案号', '', '', 6, 0, 'text', '设置在网站底部显示的备案号，如“苏ICP备1502009-2号\"', 1378900335,  8, 1),
(9, 'web_site_statistics', '站点统计', '站点统计', '', '', 1, 0, 'textarea', '支持百度、Google、cnzz等所有Javascript的统计代码', 1378900335,  9, 1),
