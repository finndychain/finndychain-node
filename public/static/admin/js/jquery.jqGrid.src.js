...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><i class='ace-icon fa fa-spinner fa-spin orange bigger-125'></i> "+this.p.loadtext+"</div>").insertBefore(gv);
		...
		$(grid.cDiv).append(arf).append("<span class='ui-jqgrid-title'><i class='fa fa-table'></i> "+ts.p.caption+"</span>")
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				//if(o.add || o.edit || o.del || o.view) {$("tr",navtbl).append(sep);} //midytag1
				if (o.search) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					pSearch = pSearch || {};
                ...
                //move from top midytag1
                if(o.add || o.edit || o.del || o.view || o.search || o.refresh) {$("tr",navtbl).append(sep);}
				tdw = $(".ui-jqgrid").css("font-size") || "11px";
